...
class PartidaRepositoryTest {
    ...
    void testPersistirYRecuperarPartida() {
        ...
        // Configurar partida - ID will be auto-generated by Hibernate
    ...
    void testActualizarPartida() {
        // Crear partida inicial - ID will be auto-generated by Hibernate
        Partida partida = new Partida();
    ...
    void testEliminarPartida() {
        // Crear partida - ID will be auto-generated by Hibernate
        Partida partida = new Partida();
        partida.setEquipos(new ArrayList<>());
